...
- Current CGPA: 9.91
- Passionate about: Software Development, UI/UX Design, Data Science, AI, Cloud Computing, Cybersecurity, and Aerospace Computing
...
**Technical:**  
C | C++ | Java | Python | HTML | CSS | JavaScript | React (Basics) | SQL (Basics) | Git | Figma | Canva

**Soft Skills:**  
Problem Solving | Strategic Planning | Teamwork | Public Speaking | Creative Writing
...
- Smart Pill Dispenser: Automated pill distribution system (COA course project)
- Local Travel Guide Website: Discover places with a simple web app (HTML, CSS, JS)
...
- Associate Lead of Operations: TEDxSRMIST
- Associate Lead of Editorial: SRMKZILLA (Content Writing)
- Hackathon Enthusiast: Participated in Adobe India Hackathon & multiple SRMIST hackathons
...
- Email: anushka.anchu@gmail.com
- LinkedIn: [Anushka Rakesh](https://www.linkedin.com/in/anushka-rakesh-605466324)
- GitHub: [anushkaraks](https://github.com/anushkaraks)

---

Thanks for stopping by! Feel free to explore my projects or reach out—I'm always excited to connect and collaborate!
